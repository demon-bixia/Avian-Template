...
const style = computed(() => {
  ...
  if (props.variant && props.variant.includes("heading")) {
    if (props.variant === "heading-1") {
      return props.noColor
        ? "outline-none text-xl leading-4 tracking-[0.16px]"
        : "outline-none text-black opacity-60 dark:text-white text-xl leading-4 tracking-[0.16px]";
    }
  ...
  // display texts
    ...
    return props.noColor
      ? "outline-none font-display text-3xl leading-[64px] tracking-[0px]"
      : "outline-none font-display text-3xl text-black opacity-60 dark:text-white dark:opacity-70 leading-[64px] tracking-[0px]";
  }
...
const textStyle = twMerge(style.value, props.customStyle);
</script>
