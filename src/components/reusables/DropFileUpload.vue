  ...
  <div class="flex flex-col">
    ...
    <div class="flex justify-start">
      <label v-if="props.label" :for="props.id" class="mb-3">
        <span
          class="w-13 text-black opacity-60 dark:text-white dark:opacity-70 text-sm font-semibold leading-4 tracking-[0.16px]"
        >
          {{ props.label }}
        </span>
      </label>
    ...
    <label
      ...
      :class="{
        'bg-opacity-0': active,
        'bg-gray-50 bg-opacity-100 dark:bg-opacity-70 dark:bg-gray-700 dark:hover:bg-opacity-0 dark:focus:bg-opacity-0':
          !active,
      }"
    >
      <!--file input-->
