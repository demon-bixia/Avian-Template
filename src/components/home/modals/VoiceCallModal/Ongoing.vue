    ...
    <div class="w-full h-full pt-6 flex flex-col items-center">
        ...
        <div class="mb-9 flex">
            ...
            <div class=" mr-5 first-letter:flex flex-col justify-center items-center">
                <button class="p-3 mb-3 flex justify-center items-center rounded-full outline-none 
                                bg-gray-100 hover:bg-gray-200 focus:bg-gray-200 active:bg-gray-200 
                                dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:active:bg-gray-500 
        ...
        <div class="relative w-full h-[50px] rounded-b flex justify-center bg-gray-50 dark:bg-gray-700">
            <div class="absolute bottom-[19px]">
                <div class="p-3 rounded-full bg-white dark:bg-gray-800">
                    <button @click="()=> { props.closeModal() }" class="p-[17px] flex justify-center items-center rounded-full outline-none
