    ...
    <div class="xs:mb-6 md:mb-5 flex" :class="{ 'justify-end': props.self }">
      ...
      <div class="mr-4" :class="{ 'ml-[36px]': props.followUp && !divider }">
        <div
          v-if="!hideAvatar()"
          tabindex="0"
          :aria-label="getFullName((props.message as Message).sender)"
          class="outline-none"
        >
          <div
            :style="{ backgroundImage: `url(${(props.message as Message).sender.avatar})` }"
      ...
      <div class="flex items-end">
        ...
        >
          <!--reply to-->
          <ReplyPreview
            v-if="props.replyToMessage"
            :message="(props.replyToMessage as Message)"
            :self="props.self"
            class="mb-5 px-3"
          />
          ...
          >
            <Recording
              :recording="(props.message.content as RecordingType)"
              :self="props.self"
            />
          </div>
          ...
          <LinkPreview
            ...
            :self="props.self"
            :preview-data="(props.message.previewData as PreviewData)"
            class="mt-5"
          />
        </div>
    ...
    >
      <DropdownLink
        :handle-click="
          () => {
            ...
            selectMessageToReplyTo(props.message);
          }
        "
      >
      ...
      <DropdownLink
        :handle-click="
          () => {
            handleCloseContextMenu();
            props.handlePinMessage(props.message.id);
          }
        "
      >
