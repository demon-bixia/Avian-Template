...
<template>
    <div>
        <Conversation v-for="conversation in filteredConversations" :conversation="conversation" :key="conversation.id"
            role="listitem" :handle-conversation-change="props.handleConversationChange"
