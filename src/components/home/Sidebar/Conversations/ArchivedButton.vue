...
<template>
    <div>
        <button :aria-label="'toggle archived conversations'"
            ...
            :class="props.open
            ? [ 'bg-red-300', 'hover:bg-red-400', 'focus:bg-red-400', 'active:bg-red-400',
             'dark:hover:bg-red-400', 'dark:focus:bg-red-400', 'dark:active:bg-red-500'] 
             
            : ['focus:bg-indigo-50', 'dark:active:bg-gray-600', 'dark:focus:bg-gray-600', 
            'dark:hover:bg-gray-600', ' hover:bg-indigo-50', 'active:bg-indigo-100']" tabindex="0">
            ...
            <div class="w-full h-full flex justify-center items-center " :class="{'hidden': !props.open}">
                <XMarkIcon class="w-5 h-5 mr-3 stroke-1"
                    :class="props.open ? ['text-white', 'dark:text-white',  'group-hover:text-white', 'group-focus:text-white'] : []" />
            ...
            <div class="w-full flex flex-col" :class="{'hidden': props.open}">
                ...
                <div>
                    ...
                    <Typography variant="body-2" class="flex justify-start items-center">
                        {{(chat.archivedConversations as Conversation[]).length}} conversations
                    </Typography>
                </div>
            </div>
        </button>
