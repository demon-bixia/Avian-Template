...
import NoNotifications from "../../../reusables/empty/NoNotifications.vue";
...
<template>
  <div>
    ...
    >
      ...
      <Notification
        v-else-if="chat.status === 'success' && !chat.delayLoading"
        v-for="(notification, index) in chat.notifications"
