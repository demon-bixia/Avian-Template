...
import NoCalls from "../../../reusables/empty/NoCalls.vue";
    ...
    >
      ...
      <div v-else>
        <ExpandTransition>
          <div
            class="max-h-[200px]"
            v-if="chat.callMinimized && chat.activeCall"
          >
            <Call
              v-if="chat.activeCall"
              :call="chat.activeCall"
        ...
        <CallList
          v-if="(chat.calls as CallType[])?.length > 0"
          :calls="(chat.calls as CallType[])"
