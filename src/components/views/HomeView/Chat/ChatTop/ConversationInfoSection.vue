  ...
  <div class="w-full flex justify-center items-center">
    ...
    <div v-if="store.status !== 'loading'" class="flex grow">
      ...
      <div class="flex flex-col">
        <Typography variant="heading-2" @click="props.handleOpenInfo" class="mb-2 default-outline cursor-pointer"
          tabindex="0">
    ...
    <div class="flex" :class="{ hidden: store.status === 'loading' }">
      ...
      <div class="relative">
        ...
        <IconButton id="open-conversation-menu" @click="showDropdown = !showDropdown" tabindex="0"
          ...
          <EllipsisVerticalIcon class="open-top-menu w-[20px] h-[20px] text-gray-400 group-hover:text-indigo-300" />
        </IconButton>
        ...
        <Dropdown id="conversation-menu" :close-dropdown="() => (showDropdown = false)" :show="showDropdown"
          ...
          <DropdownLink :handle-click="() => { handleCloseDropdown(); props.handleOpenInfo(); }">
