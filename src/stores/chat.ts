...
export interface Settings {
  "last-seen": boolean;
  "read-receipt": boolean;
  "joining-groups": boolean;
  "private-messages": boolean;
  "dark-mode": boolean;
  "bordered-theme": boolean;
  "allow-notifications": boolean;
  "keep-notifications": boolean;
}
...
const useChatStore = defineStore("chat", () => {
  ...
  const activeConversationId: Ref<number | null> = ref(
